...
import com.zero9platform.domain.user.Service.UserDummyDataService;
...
public class DummyInitializer implements CommandLineRunner {
    ...
    private final UserDummyDataService userDummyDataService;
    ...
    public void run(String... args) throws Exception {
        ...
        userDummyDataService.createDummyUsers(100000);*/
    }
}
