...
public class SearchLogController {
    ...
    public ResponseEntity<CommonResponse<List<SearchLogItemResponse>>> searchLogGetListHandler() {

        // 검색 서비스 호출
        List<SearchLogItemResponse> searchLogListResponses = searchLogService.searchLogProductNameList();
